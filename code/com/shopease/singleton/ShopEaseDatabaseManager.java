...
/**
 * Singleton Pattern — one SQLite connection manager for the whole application.
 * DAO classes obtain connections through {@link #getConnection()}; schema setup runs once via
